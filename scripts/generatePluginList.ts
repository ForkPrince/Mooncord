            ...
            switch (key) {
                ...
                case "authors":
                    ...
                    data.authors = value.elements.map(e => {
                        ...
                        const d = devs[getName(e)!] || suncordDevs[getName(e)!] || equicordDevs[getName(e)!];
...
(async () => {
    ...
    await Promise.all(["src/plugins", "src/plugins/_core", "src/suncordplugins", "src/equicordplugins"].flatMap(dir =>
